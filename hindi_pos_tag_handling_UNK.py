...
text = input()
model_path = "C:\\Users\\HARSHITA\\AppData\\Roaming\\nltk_data\\corpora\\indian\\hindi.pos" 
...
def handle_UNK(tagged_words, model_path, sentence_id):
    with open(model_path, "r+",encoding="utf8") as f1:
        result_list = []
...
with open("result/handling_UNK_output.txt","a",encoding="utf8") as output_file:
